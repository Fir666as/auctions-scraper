...
The software uses a technology called Playwright with Python to handle browsing and data collection. You don’t need to know anything about coding to use it.
...
5. Once downloaded, open the file to start installation. For `.exe` or `.dmg` files, follow the instructions on your screen.

6. For `.zip` files, unzip them first, then run the program inside the folder.

7. When the installation finishes, open the app to start mining auction schedules.
...
## 🚀 How to Use auctions-scraper

After installation, follow these steps to run the application and collect auction schedules:

1. Open the auctions-scraper program from your desktop, Start menu, or applications folder.

2. On the main screen, you will see a button to start data mining. Click **Start**.

3. The app will begin visiting auction websites automatically. This may take a few minutes depending on how much data is available.

4. Once finished, the app will save the collected auction schedules to a file on your computer. You will see a confirmation message showing where the file is located.

5. Open the saved file with spreadsheet software (like Microsoft Excel or Google Sheets) to view and analyze auction details.

6. You can repeat this process whenever you want the latest auction schedules.
